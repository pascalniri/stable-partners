          ...
          <div className="flex-1 overflow-y-auto p-8 md:p-16">
            <div className="max-w-md mx-auto">
              <div className="mb-12 text-center">
                <span className="text-[10px] uppercase tracking-[0.4em] text-blue-600 font-bold mb-4 block">Access Terminal</span>
                <h2 className="text-2xl font-bold text-slate-900 mb-2">Administrator Authentication</h2>
              ...
              <form className="space-y-8" onSubmit={onSubmit}>
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <input 
                      ...
                      className={`w-full bg-slate-50 border ${errors.email ? 'border-red-500' : 'border-slate-200'} px-6 py-4 rounded-[5px] text-sm font-medium outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-600 transition-all placeholder:text-slate-400`}
                    />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <input 
                      ...
                      type="password" 
                      placeholder="••••••••"
                      className={`w-full bg-slate-50 border ${errors.password ? 'border-red-500' : 'border-slate-200'} px-6 py-4 rounded-[5px] text-sm font-medium outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-600 transition-all placeholder:text-slate-400`}
                    />
                  </div>
                </div>
                ...
                <div className="pt-4">
                  <button 
                    disabled={isLoading}
                    type="submit" 
                    className="group w-full bg-blue-600 text-white py-4 text-xs font-bold tracking-[0.2em] uppercase rounded hover:bg-blue-700 active:scale-[0.98] transition-all disabled:bg-slate-300 flex items-center justify-center gap-2 shadow-lg shadow-blue-500/20"
                  >
