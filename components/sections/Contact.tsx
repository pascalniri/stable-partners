    ...
    <section id="contact" className="bg-card relative overflow-hidden">
      ...
      <div className="container grid grid-cols-1 lg:grid-cols-2 gap-16 relative z-10 items-center">
        <div className="max-w-[500px]">
          ...
          >
            Ready to <span className="gradient-text">Stabilize</span> Your
            Future?
          </motion.h2>
          <p className="text-md text-foreground/70 leading-relaxed mb-10">
            Take the first step towards a more robust property portfolio. Book
            your initial consultation with our expert team today.
          </p>
          ...
          {status === "success" ? (
            <div className="text-center py-8 animate-fade-in">
              ...
              <p className="text-foreground/70 mb-8">
                Check your email for a "Thank You" message from us. We will be
                in touch shortly.
              </p>
              <button
