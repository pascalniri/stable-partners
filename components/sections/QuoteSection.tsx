      ...
      <div className="container relative">
        ...
        >
          <div className="inline-block mb-12">
            <span className="text-8xl text-slate-200 font-serif leading-none">
              "
            </span>
          </div>
          ...
          <h2 className="text-4xl md:text-6xl font-medium text-slate-900 leading-[1.2] mb-12">
            ...
            <span className="text-primary font-bold">
              turns complex supply chains
            </span>{" "}
            into growth engines with AI, predictive insights, and smart
            automation.
          </h2>
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            <div>
              <p className="font-bold text-slate-900 text-md uppercase tracking-wider">
                James Smith
              </p>
              <p className="text-sm text-slate-500 font-medium">
                COO at GlobalLogistics
              </p>
            </div>
          </div>
        </motion.div>
