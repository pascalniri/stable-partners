    ...
    <section className="p-0">
      <div className="container p-0 border-x border-slate-100">
        <div className="text-center py-24 border-b border-slate-100 px-6">
          <h2 className="text-4xl md:text-6xl font-bold mb-6 tracking-tight">Kickstart your business <br /> optimization in 3 easy steps</h2>
          ...
          {steps.map((step, i) => (
            ...
            >
              <div className="flex-shrink-0">
                <span className="text-8xl md:text-9xl font-bold text-slate-100 leading-none group-hover:text-primary/10 transition-colors">{step.number}</span>
              </div>
              <div className="max-w-[600px] text-center md:text-left">
                <h3 className="text-3xl md:text-4xl font-bold mb-6 text-slate-900 tracking-tight">{step.title}</h3>
